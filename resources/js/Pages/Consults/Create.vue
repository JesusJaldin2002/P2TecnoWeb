...
defineProps({ errors: Object, patients: Array, doctors: Array });
...
const submit = () => {
    router.post(route("consults.store"), form.value);
};
...
<template>
    <AppLayout title="Registrar Consulta">
        <template #header>
            <h2 class="custom-page-title">Registrar Consulta</h2>
        </template>
        ...
        <div class="custom-container">
            <div class="custom-card">
                ...
                <form @submit.prevent="submit">
                    ...
                    <!-- Seleccionar Doctor -->
                    <div class="custom-form-group">
                        <label for="doctor_id" class="custom-label"
                            >Doctor</label
                        >
                        <select
                            id="doctor_id"
