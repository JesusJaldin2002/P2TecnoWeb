...
defineProps({ errors: Object, patients: Array, rooms: Array, meals: Array });
...
// Enviar formulario
const submit = () => {
    router.post(route("treatments.store"), form);
};
...
<template>
    <AppLayout title="Registrar Tratamiento">
        <template #header>
            <h2 class="custom-page-title">Registrar Tratamiento</h2>
        </template>
            ...
            <div class="custom-card">
                ...
                <form @submit.prevent="submit">
                    ...
                    <div class="custom-form-group">
                        ...
                        <div v-if="errors.meals || errors['meals.*']" class="custom-error-message">
                            {{ errors.meals || "Debe seleccionar al menos un producto válido." }}
                        </div>
                    </div>
